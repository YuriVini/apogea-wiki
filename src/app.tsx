      ...
      <header className='bg-gray-800/50 p-4 shadow-lg'>
        <div className='max-w-7xl mx-auto flex justify-between items-center'>
          ...
          <nav className='space-x-6'>
            <a href='#' className='text-gray-300 hover:text-white'>Guia Inicial</a>
            <a href='#' className='text-gray-300 hover:text-white'>Classes</a>
            <a href='#' className='text-gray-300 hover:text-white'>Dungeons</a>
            <a href='#' className='text-gray-300 hover:text-white'>Crafting</a>
          </nav>
        </div>
      </header>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          ...
          <div className='bg-gray-800/30 rounded-lg p-6 shadow-lg'>
            ...
            <ul className='space-y-3'>
              <li className='text-gray-300 hover:text-white cursor-pointer'>Primeiros Passos em Apogea</li>
              <li className='text-gray-300 hover:text-white cursor-pointer'>Sistema de Combate</li>
              <li className='text-gray-300 hover:text-white cursor-pointer'>Progressão de Personagem</li>
            </ul>
          </div>
          ...
          <div className='bg-gray-800/30 rounded-lg p-6 shadow-lg'>
            ...
            <ul className='space-y-3'>
              <li className='text-gray-300 hover:text-white cursor-pointer'>Guerreiro</li>
              <li className='text-gray-300 hover:text-white cursor-pointer'>Mago</li>
              <li className='text-gray-300 hover:text-white cursor-pointer'>Arqueiro</li>
              <li className='text-gray-300 hover:text-white cursor-pointer'>Rogue</li>
            </ul>
          </div>
          ...
          <div className='bg-gray-800/30 rounded-lg p-6 shadow-lg'>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <p className='text-gray-300'>Novo Dungeon: Cavernas Cristalinas</p>
              </div>
              <div>
                <p className='text-sm text-gray-400'>20/03/2024</p>
                <p className='text-gray-300'>Atualização do Sistema de Crafting</p>
              </div>
              <div>
      ...
      <footer className='bg-gray-800/50 text-gray-300 py-8 mt-12'>
        <div className='max-w-7xl mx-auto px-6'>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div>
              <h3 className='text-white text-lg font-bold mb-4'>Sobre WikiApogea</h3>
            ...
            <div>
              ...
              <ul className='space-y-2 text-sm'>
                <li><a href="#" className='hover:text-white'>Regras do Jogo</a></li>
