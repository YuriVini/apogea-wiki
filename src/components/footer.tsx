        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          <div>
            ...
            <div className='flex space-x-4'>
              <Link to='https://discord.gg/byPJnAjG4C' target='_blank' className='hover:text-white flex items-center gap-2'>
              ...
              <Link to='https://x.com/TrinitasGames' target='_blank' className='hover:text-white flex items-center gap-2'>
                <svg className='w-5 h-5' viewBox='0 0 24 24' fill='currentColor'>
                  <path d='M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z' />
                </svg>
                Twitter
              </Link>
              <Link to='https://www.patreon.com/Apogea' target='_blank' className='hover:text-white flex items-center gap-2'>
                <svg className='w-5 h-5' viewBox='0 0 24 24' fill='currentColor'>
            ...
            <Link
              to='https://store.steampowered.com/app/2796220/Apogea/'
