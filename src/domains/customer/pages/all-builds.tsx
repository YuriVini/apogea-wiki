    ...
    <div>
      ...
      <div className='min-h-screen bg-gray-900'>
        <div className='max-w-7xl mx-auto p-6'>
          <div className='mb-8'>
            <h1 className='text-4xl font-bold text-white text-center mb-4 animate-fade-in-down'>Todas as Builds</h1>
            <p className='text-gray-300 text-center'>Explore nossa coleção completa de builds para melhorar sua experiência no jogo</p>
          </div>
              ...
              {filteredBuilds.map((build) => (
                ...
                >
                  ...
                  <Link to={`/builds/${build.id}`} className='block'>
                    ...
                    <p className='text-gray-300 mb-4 line-clamp-3'>{build.overview}</p>
          ...
          {!loading && filteredBuilds.length === 0 && (
            <div className='text-center py-3'>
              <p className='text-gray-300 mb-4'>Nenhuma build encontrada para a classe selecionada.</p>
              <Link to='/builds/create' className='inline-block px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200'>
