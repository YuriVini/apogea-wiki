...
export const CharacterClass = () => {
  ...
  const classData = useMemo(
    () => CHARACTER_CLASS_DATABASE.find((c) => c.type === className),
    [className],
  );
              ...
              <div className="bg-gray-800/30 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="space-y-4">
                  {classData?.playstyle?.map((style, index) => (
                    ...
                    >
                      <h3
                        className={`text-${index === 0 ? "blue" : "green"}-300 font-bold mb-2`}
                      >
                        {style.title}
                      </h3>
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {classData?.abilities?.map((ability, index) => (
                  <div
                    key={index}
                    className="bg-gray-800/30 rounded-lg p-6 shadow-lg hover:bg-gray-700/30 transition-all duration-300 transform hover:scale-105"
                  >
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {classData?.recommendedEquipment?.map((equipment, index) => (
                  <div
                    key={index}
                    className="bg-gray-800/30 rounded-lg p-6 shadow-lg text-center hover:bg-gray-700/30 transition-all duration-300 transform hover:scale-105"
                  >
                    {equipment.icon && (
                      <img
                        src={equipment.icon}
          ...
          <div className="mb-12">
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-lg text-blue-400 mb-2">
                          Nível {build.characterStats.level}
                        </p>
                      </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-400 mb-4">
                Não encontrou a build perfeita?
              </p>
              {isLoggedIn ? (
                <button
