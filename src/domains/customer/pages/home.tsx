            ...
            <div className="bg-gray-800/30 rounded-lg p-6 shadow-lg transition-all duration-300 hover:scale-105 hover:bg-gray-700/30">
              ...
              <ul className="grid grid-cols-2 h-full">
                {caracterClasses.map((caracterClass, index) => (
                  <li
                    key={index}
                    className="flex justify-center cursor-pointer transition-colors duration-200"
                  >
                    <Link
                      to={`/character-class/${caracterClass.type}`}
                      className="flex flex-col items-center"
                    >
                      <img
                        src={caracterClass.imageUrl}
                        alt={caracterClass.title}
            ...
            <div className="mb-10">
              ...
              <div className="bg-gray-800/30 rounded-lg p-8 shadow-lg max-w-6xl mx-auto">
                ...
                <div className="flex justify-center items-center gap-1">
                  <div className="text-center mt-6">
                    <Link
                      to={isLoggedIn ? "/builds/create" : "/login"}
                      className="inline-block px-6 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-colors"
                    >
                      Criar minha build
                    </Link>
