            ...
            <div className='bg-gray-700/30 rounded-lg p-4 sm:p-6 w-full'>
              <div className='flex flex-col sm:flex-row items-center sm:items-start mb-6 gap-4 sm:gap-6'>
                <div className='flex-shrink-0'>
                  <div className='w-24 h-24 rounded-full overflow-hidden border-4 border-gray-600 bg-gray-900 flex items-center justify-center'>
                    {user?.avatar_url ? (
                      ...
                      <span className='text-4xl text-gray-500'>{user?.name?.[0]?.toUpperCase() || 'U'}</span>
                    )}
                  </div>
                </div>
                <div className='flex-1 text-center sm:text-left'>
                  ...
                  <p className='text-gray-400 text-sm'>Visualize e edite suas informações pessoais.</p>
                </div>
              </div>
              <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
                <div className='grid grid-cols-1 gap-4'>
                  ...
                  />
                  <TextInput title='Email' name='email' control={control} disabled className='w-full bg-gray-600/30 rounded-lg p-3 text-white border border-gray-500/30' />
                  <TextInput
                    title='Membro desde'
                    name='created_at'
                    control={control}
