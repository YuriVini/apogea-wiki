              ...
              <table className='w-full text-sm'>
                <thead>
                  <tr className='bg-purple-900/30 text-gray-300'>
                    ...
                    {!isArmorOrAccessory ? (
                      <>
                        <th className='text-center p-4 border-r border-gray-600 font-semibold'>Dano</th>
                        <th className='text-center p-4 border-r border-gray-600 font-semibold'>Velocidade de Ataque</th>
                        <th className='text-center p-4 border-r border-gray-600 font-semibold'>Alcance</th>
                        <th className='text-center p-4 border-r border-gray-600 font-semibold'>Defesa</th>
                      </>
                    ) : (
                    ...
                    <th className='text-center p-4 border-r border-gray-600 font-semibold'>Vender Para</th>
                    {renderEditHeader()}
                  </tr>
                </thead>
                <tbody>
                  {filteredWeapons.map((weapon, index) => (
                    <tr key={index} className='border-b border-gray-700 hover:bg-gray-700/30 transition-colors'>
                      ...
                      <td className='p-4 border-r border-gray-600 text-yellow-400 font-medium text-center'>{weapon.name}</td>
                      {!isArmorOrAccessory ? (
                        <>
                          <td className='p-4 border-r border-gray-600 text-green-400 text-center'>{weapon.damage}</td>
                          <td className='p-4 border-r border-gray-600 text-blue-400 text-center'>{weapon.attackSpeed}</td>
                          <td className='p-4 border-r border-gray-600 text-orange-400 text-center'>{weapon.range}</td>
                          <td className='p-4 border-r border-gray-600 text-purple-400 text-center'>{weapon.defense}</td>
                        </>
                      ) : (
                      ...
                      <td className='p-4 border-r border-gray-600 text-green-300 text-center'>{weapon.sellTo}</td>
