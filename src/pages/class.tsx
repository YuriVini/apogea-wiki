            ...
            <main className='max-w-7xl mx-auto p-6'>
                <div className='mb-8'>
                    ...
                    <p className='text-gray-300 text-center max-w-3xl mx-auto'>
                        Escolha sua classe e domine os campos de batalha de Apogea. Cada classe possui habilidades únicas, 
                        estilos de combate distintos e caminhos de progressão especializados.
                    </p>
                </div>
                    ...
                    {classes.map((classInfo, index) => (
                        ...
                        >
                            <div className='mb-6'>
                                ...
                                <div className='mt-3 inline-block px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-xs border border-blue-400/30'>
                                    {classInfo.playstyle}
                                </div>
                            </div>
                                ...
                                <div className='grid grid-cols-2 gap-3'>
                                    {Object.entries(classInfo.stats).map(([stat, value]) => (
                                        <div key={stat} className='flex justify-between items-center bg-gray-700/30 rounded p-2'>
                                            <span className='text-gray-300 capitalize text-sm'>{stat === 'health' ? 'Vida' : stat === 'damage' ? 'Dano' : stat === 'defense' ? 'Defesa' : 'Velocidade'}:</span>
                                            <span className={`text-sm font-medium ${
                                                value === 'Alto' ? 'text-green-400' : 
                                                value === 'Médio' ? 'text-yellow-400' : 
                                                'text-red-400'
                                            }`}>
                                                {value}
                                            </span>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        <div>
                            ...
                            <p className='text-gray-300 text-sm'>
                                Recomendamos começar com <strong>Squire</strong> para aprender os fundamentos do jogo, 
                                ou <strong>Knight</strong> se preferir um estilo mais defensivo e resistente.
                            </p>
                        </div>
                        <div>
                            <h3 className='text-lg font-semibold text-green-300 mb-2'>⚔️ Para Veteranos</h3>
                            <p className='text-gray-300 text-sm'>
                                <strong>Mage</strong> e <strong>Rogue</strong> oferecem gameplay mais complexo e recompensador, 
                                mas exigem maior conhecimento de mecânicas e posicionamento.
                            </p>
                        </div>
                    </div>
                </div>
